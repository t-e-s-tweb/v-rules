...
gh api https://api.github.com/repos/hagezi/dns-blocklists/contents/wildcard/pro-onlydomains.txt -H "Accept: application/vnd.github.raw" >> category-ads-all-raw.txt
